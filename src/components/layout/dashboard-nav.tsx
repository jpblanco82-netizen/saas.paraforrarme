...
import { Sparkles, LayoutDashboard, PlusCircle, CreditCard, LogOut, BookOpen } from "lucide-react";
...
export function DashboardNav({ userEmail }: { userEmail?: string }) {
  ...
  const links = [
    ...
    { href: "/dashboard/guide", label: "Manual de Uso", icon: BookOpen },
    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-800 bg-slate-950/80 backdrop-blur-md">
      <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <form action={signOut}>
            <Button variant="ghost" size="sm" type="submit" className="text-slate-400 hover:text-red-400 hover:bg-slate-900 gap-1.5">
